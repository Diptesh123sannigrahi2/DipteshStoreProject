    ...
    <div class="header">
        ...
        <div class="search-container">
            <form action="" method="POST">
                <input type="text" placeholder="Search Shop" name="search" required>
            ...
            <div class="row">
                <div class="col-4">
                    ...
                    if (isset($_POST['submit'])) {
                        $search = $_POST['search'];
                        $sequery = "SELECT * FROM `shop` where name LIKE '%{$search}%' or Type LIKE '%{$search}%'  order by id desc ";
                    ...
                    ?>
                            <div class="col-4">
                                ...
                                <a href="Product.php?id=<?php echo $data['Shop_id']  ?>">
